...
from models import  MyRNN, LSTM_autoreg_torchscript, LSTM_torchscript
from models import SRNN_autoreg_torchscript, LSTM_autoreg_torchscript_radflux
from models import SpaceStateModel_autoreg, LSTM_autoreg_torchscript_perturb
...
def main(cfg: DictConfig):
    ...
    if cfg.model_type=="LSTM":
        if cfg.autoregressive:
            ...
            model_det = LSTM_torchscript(hyam,hybm,
                        out_scale = yscale_lev,
                        out_sfc_scale = yscale_sca, 
                        nx = nx, nx_sfc=nx_sfc, 
                        ny = ny, ny_sfc=ny_sfc, 
        ...
        model_det = SRNN_autoreg_torchscript(hyam,hybm,hyai,hybi,
                    out_scale = yscale_lev,
                    out_sfc_scale = yscale_sca, 
                    xmean_lev = xmean_lev, xmean_sca = xmean_sca, 
                    xdiv_lev = xdiv_lev, xdiv_sca = xdiv_sca,
        ...
        model_det = LSTM_autoreg_torchscript_radflux(hyam,hybm,hyai,hybi,
                    out_scale = yscale_lev,
                    out_sfc_scale = yscale_sca, 
                    xmean_lev = xmean_lev, xmean_sca = xmean_sca, 
                    xdiv_lev = xdiv_lev, xdiv_sca = xdiv_sca,
      ...
      print("using SSM")
      model_det = SpaceStateModel_autoreg(hyam,hybm,hyai,hybi,
                    out_scale = yscale_lev,
                    out_sfc_scale = yscale_sca, 
                    xmean_lev = xmean_lev, xmean_sca = xmean_sca, 
                    xdiv_lev = xdiv_lev, xdiv_sca = xdiv_sca,
    ...
    layer_names = ["mlp_initial", "mlp_surface1", "mlp_surface2", "mlp_toa1", 
    ...
    # for layer_name in ["mlp_output", "mlp_surface_output"]:
    #     layer_ref = getattr(model_det, layer_name)
    #     getattr(model, layer_name).load_state_dict(layer_ref.state_dict())
